...
declare namespace Http {
  ...
  type nodeRes = {
    [key in
      ...
      | 'serviceUnavailable'
      | 'gatewayTimeout'
      | 'httpVersionNotSupported']: (content: any, generateEtag: string) => void;
  };
...
declare namespace Database {
  ...
  interface Transaction extends QueryInterface {
    savepoint(transactionScope: (trx: Transaction) => any): any;
...
declare namespace Lucid {
  ...
  namespace Relations {
    ...
    interface BelongsToMany extends BaseRelation {
       ...
       */
      attach(
        references: Number | String | Array<String>,
